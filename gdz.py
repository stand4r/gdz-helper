...
import requests
import webbrowser
from tkinter import Tk,Label,Button,Entry,Toplevel,PhotoImage, Canvas
...
class Algebra:
    ...
    def create_label_bg(self):
        ...
        self.bg_lbl_2 = Label(self.root, borderwidth=3, relief='solid', bg='grey', width=92, height=22)
